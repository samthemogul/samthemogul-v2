  ...
  return (
    <footer className='mt-32 mb-10'>
      <ul className='flex gap-5 justify-center items-center m-5'>
        ...
        <li className='text-2xl text-gray-700 hover:text-indigo-500 duration-300'><Link href={`https://web.whatsapp.com`}><FontAwesomeIcon icon={faWhatsapp} /></Link></li>
        <li className='text-2xl text-gray-700 hover:text-indigo-500 duration-300'><Link href={`https://instagram.com/samthemogul`}><FontAwesomeIcon icon={faInstagram} /></Link></li>
      </ul>
