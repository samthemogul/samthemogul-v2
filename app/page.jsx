...
const Home = () => {
  return (
    ...
    <section className='mt-60 flex flex-col gap-2 w-full'>
        ...
        <p className='text-gray-500 sm:text-lg my-4'>I'm a passionate Fullstack Engineer with 2 years' experience crafting visually captivating and intuitive web <br className='hidden sm:block' /> solutions. Let's embark on an innovative journey together where every click tells a story!</p>
